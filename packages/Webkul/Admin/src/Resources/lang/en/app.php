...
return [
    ...
    'users' => [
        ...
        'login-error-lockout' => 'Too many login attempts. Please try again in :minutes minutes.',
        'idle-timeout' => 'Your session has expired due to inactivity. Please log in again.',
        'session-expired' => 'Your session has reached the maximum duration. Please log in again.',
        'emergency' => [
            'grant-title' => 'Grant Emergency Access',
            'access-title' => 'Emergency Access',
            'target-email' => 'User Email',
            'grant-btn' => 'Generate Token',
            'access-btn' => 'Access Account',
            'token' => 'Emergency Token',
            'token-generated' => 'Emergency access token generated. Share it securely with the user.',
            'token-warning' => 'This token will expire in 1 hour. For security, share it via a phone call or other out-of-band method.',
            'token-expired' => 'The emergency token has expired or does not exist.',
            'invalid-token' => 'The emergency token is invalid.',
            'back-to-login' => 'Back to Login',
            'cancel' => 'Cancel',
            'login-link' => 'Emergency Access',
        ],
    ...
    'contacts' => [
        'persons' => [
            ...
            'view' => [
                ...
                'mailing-lists' => [
                    'title' => 'Mailing Lists',
                    'no-lists' => 'No mailing lists available.',
                    'subscribed' => 'Subscribed to :list',
                    'unsubscribed' => 'Unsubscribed from :list',
                    'subscribed-success' => 'Successfully subscribed to :list.',
                    'unsubscribed-success' => 'Successfully unsubscribed from :list.',
                ],
                'activities' => [
                    'index' => [
                        'all' => 'All',
    ...
    'settings' => [
        ...
        'mailing-lists' => [
            'index' => [
                'create-btn' => 'Create Mailing List',
                'title' => 'Mailing Lists',
                ...
                'create' => [
                    ...
                    'description' => 'Description',
                    'save-btn' => 'Save Mailing List',
                ],
            ],
            'subscribers' => [
                'create-btn' => 'Add Subscriber',
                'title' => 'Subscribers - :name',
                'create-success' => 'Subscriber added successfully.',
                'update-success' => 'Subscriber updated successfully.',
                'delete-success' => 'Subscriber deleted successfully.',
                'subscribed-success' => 'Subscriber subscribed successfully.',
                'unsubscribed-success' => 'Subscriber unsubscribed successfully.',
                'mass-toggle-success' => 'Subscribers toggled successfully.',
                'datagrid' => [
                    'delete' => 'Delete',
                    'edit' => 'Edit',
                    'toggle' => 'Toggle',
                ...
                'already-exists' => 'This contact is already subscribed to this mailing list.',
                'bulk-add-btn' => 'Bulk Add',
                'bulk-add-title' => 'Bulk Add Subscribers',
                'bulk-add-search' => 'Search and add contacts',
                'bulk-add-selected' => 'selected',
                'bulk-add-submit' => 'Add :count People',
                'bulk-add-success' => ':count subscriber(s) added successfully.',
                'bulk-add-none' => 'No new subscribers were added — all selected contacts are already subscribed.',
                'bulk-add-skipped' => ':count already-subscribed contact(s) were skipped.',
                'subscribe-all-btn' => 'Add All Contacts',
                'subscribe-all-success' => ':count contact(s) subscribed successfully.',
                'subscribe-all-none' => 'All contacts are already subscribed to this mailing list.',
                'create' => [
                    'contact' => 'Contact',
    ...
    'layouts' => [
        ...
        'mailing-lists' => 'Mailing Lists',
        'mailing-lists-info' => 'Manage email subscriber lists in the CRM',
    ...
    'user' => [
        'two-factor' => [
            'setup-title' => 'Two-Factor Authentication Setup',
            'setup-heading' => 'Set Up Two-Factor Authentication',
            'setup-instruction' => 'Scan the QR code below with your authenticator app (e.g. Google Authenticator, Authy) and enter the verification code.',
            'challenge-title' => 'Two-Factor Authentication',
            'challenge-instruction' => 'Enter the verification code from your authenticator app.',
            ...
            'cancel' => 'Cancel',
            'done' => 'Done',
            'manual-entry' => 'Or enter this key manually:',
            'verify-code' => 'Verify Code',
            'recovery-codes-title' => 'Recovery Codes',
            'recovery-codes-heading' => 'Save Your Recovery Codes',
            'recovery-codes-instruction' => 'Store these recovery codes in a safe place. Each code can be used only once.',
            'recovery-codes-warning' => 'If you lose your device and don\'t have your recovery codes, you will lose access to your account.',
